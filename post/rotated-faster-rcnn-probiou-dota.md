...
tags:
  ...
  - probiou
  - pytorch
cover: images/hero_satellite_obb.png
slug: rotated-faster-rcnn-probiou-dota
---

![Satellite scene with oriented bounding boxes](images/hero_satellite_obb.png)
...
![Two IoU backends in OrientedDet: exact polygon IoU vs sampled GPU rIoU](images/sampled_vs_exact.png)
...
![Sampling error vs grid spacing](images/sampling_error_vs_spacing.png)
...
![OBB to Gaussian to ProbIoU](images/probiou_concept.png)
...
Full per-class tables: local eval-val run `predictions/20260710_044125/` (checkpoint `best_mAP_0.83.pth`).
...
![Per-class AP gains vs CE](images/per_class_ap_delta.png)
