...
All **eight** DOTA Hub slugs now have **official Task 1** (hidden test). Recipes train on **trainval**, so local `make eval-val` is a leaky monitor — do not quote it as the zoo number.

| Model | 1× AP50 | 3× AP50 | Δ AP50 | 1× AP75 | 3× AP75 |
|---|---:|---:|---:|---:|---:|
