---
title: "Oriented-Det v0.3.0 — four datasets, and ONNX export"
author: "Jeff Faudi"
date: 2026-09-21T09:00:00+07:00
lastmod: 2026-09-21T09:00:00+07:00

description: "Oriented-det v0.3.0 is on PyPI — native HRSC2016, FAIR1M, SSDD, and HRSID loaders, HRSC Hub 3× zoo, DOTA advertised from 1×, and ONNX export."
...
subtitle: "pip install oriented-det==0.3.0"
---

Three weeks after [v0.2.0](/posts/2026-08-28_oriented-det_v0_2_0_rotated_fcos_decoded_riou_and_the_updated_zoo/), [**Oriented-Det v0.3.0**](https://github.com/DL4EO/oriented-det/releases/tag/v0.3.0) is on [PyPI](https://pypi.org/project/oriented-det/0.3.0/) and tagged on GitHub. This is the **dataset + deploy** release. The four ResNet-FPN detector families stay. What landed is four native loaders, an HRSC Hub 3× zoo, a DOTA zoo you should advertise from **1×**, and ONNX export.
...
PyTorch is still installed separately for your platform ([pytorch.org](https://pytorch.org/get-started/locally/)). Weights stay on Hugging Face at `dl4eo/oriented-det-pretrained`. For ONNX export from a checkout: `uv pip install -e ".[export]"` then `python -m export --help`.
...
All eight DOTA Hub slugs quote **official Task 1** (hidden test). Recipes train on trainval, so local `make eval-val` is a **leaky** monitor — do not quote it as the zoo number.
...
**Advertise and finetune from 1×** for Oriented R-CNN, Faster R-CNN, and FCOS. 3× Task 1 AP50 is a drop or a wash; the 3× gain is **box tightness** (AP75). RetinaNet 3× is the AP50 exception. Versus MMRotate 1×: Oriented R-CNN **+1.04**, Faster R-CNN **+1.02**, FCOS **+1.79**, RetinaNet **+3.32** vs HBB 64.55.
...
- Deploy floors = eval-val global F1 − 0.05; final NMS **0.1** on DOTA / HRSC recipes
...
- **Release notes**: [github.com/DL4EO/oriented-det/releases/tag/v0.3.0](https://github.com/DL4EO/oriented-det/releases/tag/v0.3.0)
- **PyPI**: [pypi.org/project/oriented-det/0.3.0](https://pypi.org/project/oriented-det/0.3.0/)
